fld = 'Y:\Calcium Imaging\Intestinal_Calcium\Exogenous_Tyramine\Receptor_Mutants\wildtype-30mM-TA'; % Folder containing the data you want to analyze
serverfolder = 'Z:\Calcium Imaging\Intestinal_Calcium\DMP_Mutants\unc-43(e408)';  % upload everything to this location.

%% settings
startIndex = 18; % which video to start analysis.
startframe =8300; % what frame to begin analysis
