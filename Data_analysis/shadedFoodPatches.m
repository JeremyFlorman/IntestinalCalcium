function [patchX, patchY] = shadedFoodPatches(foodBouts, ylims)
...
onFood = foodBouts.onStart;
offFood = foodBouts.onEnd;
...
%
% figure()
% plot(wormdata.bulkSignal)
% p = patch(patchX, patchY, [0.93 0.69 0.13], 'FaceAlpha', 0.5);
